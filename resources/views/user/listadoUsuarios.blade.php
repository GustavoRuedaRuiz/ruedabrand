        ...
        <div class="row">
            <div class="">
                <div>
                    ...
                    <h1 class="mb-5" style="align-items: center;display: flex;flex-direction: column;font-weight: bold;">Listado Usuarios</h1>
                    <div style="display:flex;">
                        <a href="{{ route('pdf.generateListadoUsuarios') }}" class="mb-4">
