...
@section('content')
    <div class="bg-light">
                    <div class="container">
                        ...
                        @hasrole('admin')
                        <a href="{{route('form_add_Collection')}}" id="buttomLogin" style="width: 15%; min-width: 194px;font-size: 17px" class="btn mb-3">+ Añadir Colección</a>
                        @endhasrole
                        <div class="row justify-content-md-center justify-content-sm-center">
                            @foreach ($collections as $collection)
                                @if($collection->trashed())
                                @hasrole('admin')
                                    <div class="col-sm-4" id="{{$collection->id}}" style="margin-bottom:10px;">
                                        <a class="imagen" href="{{route('coleccion',$collection->collection_name)}}" style="position: relative;">
                                            <img style="width: 100%;height:100%;" src="{{$collection->getMedia()->first() !== null ? $collection->getMedia()->first()->getFullUrl('thumb') : 'https://brunosmoda.com/wp-content/uploads/2021/01/CAMISETA-NEGRA-LISA-HOMBRE-10043675_000-5.jpg'}}">
                                            <div class="infobox">
                                                <div class="info">
                                                    <h1 class="name">{{$collection->collection_name}}</h1>
                                                </div>
                                            </div>
                                        </a>
                                        <div style="position: absolute;top:2%;left: 68%;width: 27%;background-color: white;border-radius: 10px;">
                                            <div style="display: flex;justify-content: space-between;align-items: center;">
                                                <a href="{{route('editCollection',$collection->collection_name)}}" style="padding-left: 9px;padding-bottom: 3px;"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a  alt="Restaurar" href="{{route('restoreCollection',$collection->id)}}" style="padding-right:11px;padding-bottom: 3px;color: red;text-decoration: none;font-size:22px">
                                    ...
                                    <div class="col-sm-4" id="{{$collection->id}}" style="margin-bottom:10px;">
                                        ...
                                        <div style="position: absolute;top:2%;left: 68%;width: 27%;background-color: white;border-radius: 10px;">
                                            <div style="display: flex;justify-content: space-between;align-items: center;">
                                                ...
                                                @method('DELETE')
                                                <a href="{{route('destroyCollection',$collection->id)}}" style="padding-right:11px;color: red;text-decoration: none;font-size:22px;font-weight: 700;">X</a>
                                            </div>
                                        </div>
                                        @endhasrole
                                    </div>
